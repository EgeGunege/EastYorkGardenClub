...
class JoinUs extends Component {
    ...
    render() {
        ...
        const { name, address, city, postalCode, phoneNumber, email, hear, errorMessage, paymentMethod, membershipType } = this.state;
            ...
            <section className="section-joinus">
                <div className="container">
                    ...
                    <div className="form-joinus">
                        <form className="member-form-container" onSubmit={this.handleFormSubmit}>
                            ...
                            <div className="field-group">
                                <button className="member-form-container" type="submit">Upload</button>
                            </div>
